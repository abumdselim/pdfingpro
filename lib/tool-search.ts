...
const TOOL_KEYWORDS: Partial<Record<string, string[]>> = {
  ...
  "word-to-pdf": ["docx", "doc", "microsoft word", "office"],
  "powerpoint-to-pdf": ["pptx", "ppt", "slides", "presentation"],
  "excel-to-pdf": ["xlsx", "xls", "spreadsheet", "office"],
  "pdfa-preflight": ["archival", "compliance", "preflight", "pdfa check"],
  "pdf-to-pdfa-server": ["pdfa", "archival", "iso", "compliance"],
