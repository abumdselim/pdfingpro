...
const TEASERS = [
  { icon: "attach_file", labelKey: "home.comingSoon.item.attachments" },
  { icon: "image", labelKey: "home.comingSoon.item.tiff" },
  { icon: "difference", labelKey: "home.comingSoon.item.compareVisual" },
