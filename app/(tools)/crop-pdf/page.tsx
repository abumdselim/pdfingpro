          ...
          {file && (
            <>
              <ToolCard className="p-4 md:p-5">
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">{t("crop.preview")}</p>
                    <TouchHint
              ...
              <ToolCard>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">{t("crop.thumbHint")}</p>
                <PDFThumbnails
                  file={file}
